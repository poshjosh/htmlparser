...
public class FormTag extends CompositeTag
{
    ...
    public InputTag getInputTag (String name)
    {
        ...
        inputTag = null;
        found = false;
        for (Iterator<Node> e = getFormInputs().iterator();e.hasNext() && !found;)
        {
            inputTag = (InputTag)e.next();
            inputTagName = inputTag.getAttributeValue("NAME");
    ...
    public TextareaTag getTextAreaTag(String name)
    {
        ...
        boolean found = false;
        for (Iterator<Node> e=getFormTextareas ().iterator();e.hasNext() && !found;)
        {
            textareaTag = (TextareaTag)e.next();
            String textAreaName = textareaTag.getAttributeValue("NAME");
