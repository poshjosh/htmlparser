...
Logger.getLogger(this.getClass().getName()).log(Level.FINER, "Charset: {0}", ret);
...
Logger.getLogger(this.getClass().getName()).log(Level.WARNING, msg.toString(), uee);
                charset = DEFAULT_CHARSET;
                mSource = new InputStreamSource (stream, charset);
            }
        }
...
Logger.getLogger(this.getClass().getName()).log(Level.FINER, "Content type: {0}", ret);
        return (ret);
    }
