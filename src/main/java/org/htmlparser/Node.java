        ...
        Cloneable
{
    ...
    public static final Node BLANK_NODE = new AbstractNode(null, 0, 0) {
        @Override
     ...
     * <pre>
     * NodeList list = new org.htmlparser.util.NodeListImpl();
     * NodeFilter filter = new TagNameFilter ("A");
     * for (NodeIterator e = parser.elements (); e.hasNext ();)
     *      e.next ().collectInto (list, filter);
     * </pre>
    ...
    Node deepClone() throws CloneNotSupportedException;

    Node deepClone(boolean parents, boolean children) throws CloneNotSupportedException;
}
