        ...
        Serializable
{
    ...
    private transient static final Logger LOG = Logger.getLogger(Page.class.getName());
    /**
     * The default charset.
...
//                    }
        ...
        LOG.log(Level.FINER, "Charset: {0}", ret);
            ...
            ParserException
    {
        ...
        try
        {
            ...
            if(LOG.isLoggable(Level.FINER)) {
                LOG.log(Level.FINER, 
                        "Content type: {0}, charset: {1}, content encoding: {2}", 
                        new Object[]{type, charset, contentEncoding});
            }
            ...
            catch (UnsupportedEncodingException uee)
            {
                ...
                LOG.log(Level.WARNING, msg.toString(), uee);
                charset = DEFAULT_CHARSET;
                mSource = new InputStreamSource (stream, charset);
            }
        }
    ...
    /**
     * Sets the source.
     * @param source The source for this page.
     */
    ...
    public String getContentType()
    {
        ...
        LOG.log(Level.FINER, "Content type: {0}", ret);
        return (ret);
    }
            ...
            ParserException
    {
        ...
        if (offset == i)
            ...
            {
                // A ParserException was originally throw
                //
//                ret = EOF;
