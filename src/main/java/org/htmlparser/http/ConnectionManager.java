...
public class ConnectionManager
{
     ...
     */
    protected Map mRequestProperties;
    ...
    /**
     * Cookie storage, a Map (by site or host) of Lists of Cookies.
     * This will be null if cookie processing is disabled (default).
     */
    protected Map mCookieJar;
     ...
     */
    public ConnectionManager (Map properties)
    {
            ...
            try
            {
                try
                {
                    ...
                    if (ret instanceof HttpURLConnection)
                    {
                        ...
                        if (null != properties)
                            for (iter = properties.keySet().iterator();
                                    iter.hasNext ();)
                            {
                    ...
                    try
                    {
                        ...
                        if (null != http)
                        {
                            ...
                            if ((3 == (code / 100)) && (repeated < this.maxRedirects))
