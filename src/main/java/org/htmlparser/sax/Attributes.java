        ...
        org.xml.sax.Attributes
{
    ...
    {
        return (mTag.getAttributes ().size () - 1);
    }
    ...
    public String getQName (int index)
    {
        ...
        attribute = (Attribute)(mTag.getAttributes ().get (index + 1));
    ...
    {
        return (mTag.getAttributeValue (localName));
    }
