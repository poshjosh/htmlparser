...
public class CompositeTag extends TagNode
{
    ...
    public Iterator<Node> children ()
    {
        ...
        if (null != getChildren ())
            ret = getChildren ().iterator ();
        else
            ret = (new org.htmlparser.util.NodeListImpl()).iterator ();
     ...
     * Equivalent to calling getChildren ().iterator ().
     * @return An iterator over the children.
     */
    public Iterator elements() {
        return (
            (null == getChildren ()) ? new org.htmlparser.util.NodeListImpl().iterator () :
    ...
    public String toPlainTextString() {
        ...
        for (java.util.Iterator<Node> e=children();e.hasNext();) {
            stringRepresentation.append(e.next().toPlainTextString());
        }
    ...
    public Tag searchByName(String name) {
        ...
        Tag tag = null;
        boolean found = false;
        for (java.util.Iterator<Node> e = children();e.hasNext() && !found;) {
            node = e.next();
     ...
     * @param visitor The <code>AbstractNodeVisitor</code> object to be signalled
     * for each child and possibly this tag.
     */
    public void accept (NodeVisitor visitor)
    {
        java.util.Iterator<Node> children;
        Node child;
    ...
    public Text[] digupStringNode(String searchText) {
        ...
        NodeList stringNodes = new NodeListImpl();
        ...
        for (int i=0;i<stringNode.length;i++) {
            stringNode[i] = (Text)stringNodes.get(i);
        }
        return stringNode;
    }
