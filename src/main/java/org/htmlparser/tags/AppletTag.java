        ...
        CompositeTag
{
     ...
     */
    public Map createAppletParamsTable ()
    {
        NodeList kids;
        Node node;
        Tag tag;
     ...
     * <em>NOTE: This was called (erroneously) getAttributeValue() in previous versions.</em>
     ...
     */
    public void setAppletParams (Map newAppletParams)
    {
        NodeList kids;
        Node node;
        Tag tag;
        ...
        kids = getChildren ();
        if (null == kids)
            kids = new org.htmlparser.util.NodeListImpl();
        else
        ...
        for (Iterator e = newAppletParams.keySet ().iterator(); e.hasNext (); )
        {
