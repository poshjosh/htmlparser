...
public class Sort
{
    ...
    /**
     * Sort a Map.
     * @param map A Map with String or Ordered keys.
     * @return A sorted array of the keys.
     * @exception ClassCastException If the keys of the Map
     * are not <code>Ordered</code>.
     */
    public static Object[] QuickSort (Map map) throws ClassCastException
    {
        Iterator e;
        boolean are_strings;
        Object[] ret;
